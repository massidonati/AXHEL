...
namespace axhel {
    ...
    void EltwiseFMAModSVE2Kernel(uint64_t* res, const uint64_t* op1, uint64_t op2, const uint64_t* op3, uint64_t n, uint64_t mod, uint64_t barr_factor) {
        ...
        for(uint64_t i=0; i<n; i+=svcntd()) {
            ...
            svuint64_t prod_lo = svmul_u64_x(pg, x, yop);
            svuint64_t prod_hi = svmulh_u64_x(pg, x, yop);
    ...
    void DispatchEltwiseFMAModSVE2Kernel(uint64_t* res, const uint64_t* op1, uint64_t op2, const uint64_t* op3, uint64_t n, uint64_t mod, uint64_t barr_factor, uint64_t prod_right_shift) {
    #define AXHEL_DISPATCH_SHIFT(SHIFT_VALUE)                                      \
        case SHIFT_VALUE:                                                          \
            EltwiseFMAModSVE2Kernel<ModFactor, SHIFT_VALUE>(                       \
    ...
    // @brief SVE2-optimized FMA
    template <int ModFactor>
    void EltwiseFMAModSVE2(uint64_t* res, const uint64_t* op1, uint64_t op2, const uint64_t* op3, uint64_t n, uint64_t mod) {
        ...
        DispatchEltwiseFMAModSVE2Kernel<ModFactor>(res, op1, op2, op3, n, mod, barr_factor, prod_right_shift);
    }


    template void EltwiseFMAModSVE2<1>(uint64_t*, const uint64_t*, uint64_t, const uint64_t*, uint64_t, uint64_t);
    
    template void EltwiseFMAModSVE2<2>(uint64_t*, const uint64_t*, uint64_t, const uint64_t*, uint64_t, uint64_t);
    
    template void EltwiseFMAModSVE2<4>(uint64_t*, const uint64_t*, uint64_t, const uint64_t*, uint64_t, uint64_t);
