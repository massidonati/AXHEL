...
namespace axhel {
    ...
    /// @brief Subtracts two vectors elementwise with modular reduction using SVE.
    ...
    /// @brief Subtracts a vector and scalar elementwise with modular reduction using SVE.
